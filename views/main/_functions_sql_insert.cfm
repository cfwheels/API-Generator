...
<cfoutput query="arguments.functions" group="functionId">
	INSERT INTO functions (name, wheelsversion, returntype, hint, examples, parentfunctionsectionid, childfunctionsectionid)
	VALUES ('#arguments.functions.name#', '#arguments.version#', '#arguments.functions.returnType#', '#sqlParameterFormat(arguments.functions.hint)#', '#sqlParameterFormat(arguments.functions.examples)#', #arguments.functions.parentFunctionSectionId#, #valueOrNull(arguments.functions.childFunctionSectionId)#);
	...
	<cfoutput>
		<cfif Len(arguments.functions.functionArgumentName) gt 0>
			...
			VALUES(@function_id, '#arguments.functions.functionArgumentName#', '#arguments.functions.type#', #arguments.functions.required#, '#arguments.functions.defaultValue#', '#sqlParameterFormat(arguments.functions.functionArgumentHint)#');
		</cfif>
	</cfoutput>
</cfoutput>